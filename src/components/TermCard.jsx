    ...
    <div className="termcard-sketch-wrap" aria-hidden="true">
      ...
      >
        ...
        <g>
          ...
          <g fill="#ffffff" stroke="#18181b" strokeWidth="2">
            <polygon points="105,145 109,141 113,145 109,149" />
            <polygon points="275,135 279,131 283,135 279,139" />
            <polygon points="135,60 138,57 141,60 138,63" />
            <polygon points="255,50 258,47 261,50 258,53" />
          </g>
        </g>
      </svg>
    </div>
